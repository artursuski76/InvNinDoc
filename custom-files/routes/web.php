...
// Invoice Ninja PL: wyszukiwanie danych firmy po NIP (Biala Lista MF)
Route::get('nip-lookup/{nip}', \App\Http\Controllers\NipLookupController::class)->middleware('throttle:60,1');
